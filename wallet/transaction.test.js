...
describe('Transaction', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is not valid', () => {
            ...
            describe('and the transaction input signature is not valid', () => {
                it('returns false and logs an error', () => {
                    transaction.input.signature = new Wallet().sign('testData');
    ...
    describe('update', () => {
        ...
        describe('and the amount is valid', () => {
            beforeEach(() => {
                ...
                nextRecipient = 'nextRecipientTest';
                nextAmount = 10;
            ...
            it('signs the transaction again', () => {
    ...
    describe('rewardTransaction()', () => {
        ...
        it('creates a transaction with the input address equal to reward input address', () => {
           expect(rewardTransaction.input.address).toEqual(REWARD_INPUT.address);
        });

        it('creates one transaction for the miner with value `MINING_REWARD`', () => {
